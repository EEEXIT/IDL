// Golang
//go:generate protoc -I. -I./googleapis -I../vendor --go_opt=paths=source_relative --go_out=plugins=grpc:../generated/go --go_opt=paths=source_relative ./meeting/meeting.proto ./meeting/auth.proto ./meeting/member.proto ./utils/paginator.proto
